...
#define RACE_BAKALI       	6
#define RACE_MOBILE			7
#define RACE_ORC			8
#define RACE_OGRE			9
#define RACE_DRAGON			10
#define RACE_UNDEAD			11
#define RACE_CAERVUNI		12
#define RACE_ANIMAL			13
#define RACE_DEMON	  		14
...
#define PRF_AUTODIAG	 34   /* Autodiagnose on prompt */
#define PRF_DISPALIGN	 35   /* Display alignment in prompt */
#define PRF_NO_AFF		 36   /* Display affections in score */
#define PRF_ANON		 37   /* Display level on who */
#define PRF_WORLD_WRITE  38   /* toggle off worldwrite for upper imms */
#define PRF_NOWHO		 39	  /* toggle being on the wholist for imms */
...
#define CON_QRACE		 31 /* Race */
#define CON_QCOLOR		 32 /* Color preference */
#define CON_QROLLSTATS   33 /* Roll Stats                   */
#define CON_QALIGN       34 /* Alignment?                   */
#define CON_QMAGERACE    35 /*  race/class restrictions     */
#define CON_QNECRORACE   36 /*  race/class restrictions     */
#define CON_QMONKRACE    37 /*  race/class restrictions     */
#define CON_QKNIGRACE    38 /*  race/class restrictions     */
#define CON_QCLERRACE    39 /*  race/class restrictions     */
#define CON_QBARBRACE    40 /*  race/class restrictions     */
#define CON_QDRUIDRACE   41 /*  race/class restrictions     */
#define CON_QPSIORACE    42 /*  race/class restrictions     */
#define CON_QMONKALIGN   43 /* Alignment restrictions       */
...
#define WEAR_HEAD       0  /**< Equipment Location Head */
#define WEAR_FACE		1  /**< Equipment Location Face */
#define WEAR_NECK_1     2  /**< Equipment Location Neck #1 */
#define WEAR_NECK_2     3  /**< Equipment Location Neck #2 */ 
...
#define WEAR_WAIST      18 /**< Equipment Location Waist */
#define WEAR_LEGS       19 /**< Equipment Location Legs */
#define WEAR_FEET       20 /**< Equipment Location Feet */
...
#define ITEM_WEAR_HEAD      1   /**< Item can be worn on head */
#define ITEM_WEAR_FACE		2   /**< Item can be worn on face */
#define ITEM_WEAR_NECK      3   /**< Item can be worn around neck */
...
#define ITEM_TWO_HANDED		  11   /* Uses two hands to wield */
/** Total number of item flags */
#define NUM_ITEM_FLAGS    12


/* ANTI flags: used by obj_data.obj_flags.anti_class_flags */
#define ITEM_ANTI_GOOD     		0	/* Not usable by good people	*/
#define ITEM_ANTI_EVIL     		1	/* Not usable by evil people	*/
#define ITEM_ANTI_NEUTRAL  		2	/* Not usable by neutral people	*/
#define ITEM_ANTI_KNIGHT   		3	/* Not usable by knights	*/
#define ITEM_ANTI_CLERIC   		4	/* Not usable by clerics	*/
#define ITEM_ANTI_BARBARIAN   	5	/* Not usable by barbarians 	*/
#define ITEM_ANTI_RANGER   		6	/* Not usable by rangers	*/
#define ITEM_ANTI_MAGE     		7	/* Not usable by mages  	*/
#define ITEM_ANTI_MONK     		8	/* Not usable by monks  	*/
#define ITEM_ANTI_NECROMANCER  	9 	/* Not usable by necromancers	*/
...
#define ITEM_NEED_KNIGHT   		0	/* Not usable by knights	*/
#define ITEM_NEED_CLERIC   		1	/* Not usable by clerics	*/
#define ITEM_NEED_BARBARIAN   	2	/* Not usable by barbarians 	*/
#define ITEM_NEED_RANGER   		3	/* Not usable by rangers	*/
#define ITEM_NEED_MAGE     		4	/* Not usable by mages  	*/
#define ITEM_NEED_MONK     		5	/* Not usable by monks  	*/
#define ITEM_NEED_NECROMANCER  	6 	/* Not usable by necromancers	*/
...
#define ITEM_ANTI_KENDER   		3    /* Not usable by kender         */
...
/* player killed by attacktype info */
#define DEATH_ATTACKTYPE   0
#define DEATH_MSG_NO	   1
...
#define LVL_IMPL	65  /**< Level of Implementors */
#define LVL_OVER 	64
#define LVL_GRGOD   63  /**< Level of Greater Gods */
#define LVL_HBUILD	62
#define LVL_GOD 	61  /**< Level of Gods */
#define LVL_DEMI	60
#define LVL_CREATR	59
#define LVL_POWER	58
#define LVL_ETERN	57
#define LVL_ETHER	56
#define LVL_SPIR	55
...
#define LVL_SAGE	53
#define LVL_BUILD	52
#define LVL_IMMORT	51  /**< Level of Immortals */
...
#define MAX_BADGE_LENGTH      7		 /* Max Immortal badge length */
...
#define CLAN_RANK_RECRUIT	2
#define CLAN_RANK_APPRENTICE	3
#define CLAN_RANK_MEMBER	4
#define CLAN_RANK_CLANNIE	5
#define CLAN_RANK_BROTHER	6
#define CLAN_RANK_HIGHMEMBER	7
#define CLAN_RANK_COMMANDER	8
#define CLAN_RANK_MASTER	9
#define CLAN_RANK_LEADER	10

/* definded clans */
#define CLAN_NONE		0
#define CLAN_LEGION		1
#define CLAN_TEST		2

#define NUM_CLANS		2	

/* Character's clan */
#define GET_CLAN(ch)      	CHECK_PLAYER_SPECIAL((ch), ((ch)->player_specials->saved.clan_name))
/* character's clan rank */
#define GET_CLAN_RANK(ch)   CHECK_PLAYER_SPECIAL((ch), ((ch)->player_specials->saved.clan_rank))

#define MAX_CLAN_LENGTH	15
...
#define NUM_OBJ_VAL_POSITIONS 5
...
struct obj_flag_data
{
  ...
  int anti_class_flags[EF_ARRAY_MAX];  /* which classes can't use it */
  int need_class_flags[EF_ARRAY_MAX];  /* which classes can use it */
  int anti_race_flags[EF_ARRAY_MAX]; /* which races can't use it */
...
struct room_data
{
  ...
  byte blood;		 /* Amount of blood lying around */
...
struct char_player_data
{
  ...
  byte remort_class;  			 /* secondary class	*/
  byte generation;  			 /* number of remorts	*/
  byte chrace;					 /* Race */
...
struct char_special_data
{
  ...
  int killed_by_attacktype[2]; /* attacktype that killed em, and the message number */
