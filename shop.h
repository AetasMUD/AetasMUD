...
#define TRADE_NOKNIGHT  	( 1 << 3)
#define TRADE_NOCLERIC		( 1 << 4)
#define TRADE_NOBARBARIAN	( 1 << 5)
#define TRADE_NORANGER		( 1 << 6)
#define TRADE_NOMAGE		( 1 << 7)
#define TRADE_NOMONK		( 1 << 8)
#define TRADE_NONECROMANCER	( 1 << 9)
#define TRADE_NODRUID		( 1 << 10)
#define TRADE_NOTHIEF		( 1 << 11)
#define TRADE_NOPSIONICIST	( 1 << 12)

/** Total number of trade types */
#define NUM_TRADERS     13
...
#define NOTRADE_MAGE(i)	        (IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOMAGE))
...
#define NOTRADE_PSIONICIST(i)	(IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOPSIONICIST))
