...
#define OBJ_ANTICLASS_FLAGGED(obj, flag) (IS_SET_AR(GET_OBJ_ANTICLASS(obj), (flag)))

#define OBJ_NEEDCLASS_FLAGGED(obj, flag) (IS_SET_AR(GET_OBJ_NEEDCLASS(obj), (flag)))

#define OBJ_ANTIRACE_FLAGGED(obj, flag) (IS_SET_AR(GET_OBJ_ANTIRACE(obj), (flag)))
...
/* For blood in rooms */
#define RM_BLOOD(room)    (world[room].blood)
...
/* Remort class of ch */
#define GET_REMORT(ch)  ((ch)->player.remort_class)
/* Generation of ch */
#define GET_GEN(ch)  ((ch)->player.generation)
/* Race of ch. */
...
/** for saving attacktypes and messages */
#define GET_KILLED_BY(ch, i)		((ch)->char_specials.killed_by_attacktype[(i)])
/** Unique ID of ch. */
...
/* Number of soul points for ch */
#define GET_SOUL_POINTS(ch)	CHECK_PLAYER_SPECIAL((ch), ((ch)->player_specials->saved.soul_points))
/* Number of deaths for ch */
...
/** The badge string for the ch. */
#define GET_BADGE(ch)		CHECK_PLAYER_SPECIAL((ch), ((ch)->player_specials->badge))
...
#define GET_OBJ_ANTICLASS(obj)  ((obj)->obj_flags.anti_class_flags)

#define GET_OBJ_NEEDCLASS(obj)  ((obj)->obj_flags.need_class_flags)

#define GET_OBJ_ANTIRACE(obj)	((obj)->obj_flags.anti_race_flags)
...
#define IS_KNIGHT(ch)   	(GET_CLASS(ch) == CLASS_KNIGHT || GET_REMORT(ch) == CLASS_KNIGHT)
#define IS_CLERIC(ch)		(GET_CLASS(ch) == CLASS_CLERIC || GET_REMORT(ch) == CLASS_CLERIC)
#define IS_BARBARIAN(ch)	(GET_CLASS(ch) == CLASS_BARBARIAN || GET_REMORT(ch) == CLASS_BARBARIAN)
#define IS_RANGER(ch)		(GET_CLASS(ch) == CLASS_RANGER || GET_REMORT(ch) == CLASS_RANGER)
#define IS_MAGE(ch)			(GET_CLASS(ch) == CLASS_MAGE || GET_REMORT(ch) == CLASS_MAGE)
#define IS_MONK(ch)			(GET_CLASS(ch) == CLASS_MONK || GET_REMORT(ch) == CLASS_MONK)
#define IS_NECROMANCER(ch)	(GET_CLASS(ch) == CLASS_NECROMANCER || GET_REMORT(ch) == CLASS_NECROMANCER)
#define IS_DRUID(ch)		(GET_CLASS(ch) == CLASS_DRUID || GET_REMORT(ch) == CLASS_DRUID)
#define IS_THIEF(ch)		(GET_CLASS(ch) == CLASS_THIEF || GET_REMORT(ch) == CLASS_THIEF)
#define IS_PSIONICIST(ch)	(GET_CLASS(ch) == CLASS_PSIONICIST || GET_REMORT(ch) == CLASS_PSIONICIST)
				
#define IS_ELF(ch)              (GET_RACE(ch) == RACE_ELF)
#define IS_DWARF(ch)            (GET_RACE(ch) == RACE_DWARF)
#define IS_HUMAN(ch)            (GET_RACE(ch) == RACE_HUMAN)
#define IS_KENDER(ch)           (GET_RACE(ch) == RACE_KENDER)
#define IS_HALF_ORC(ch)         (GET_RACE(ch) == RACE_HALF_ORC)
#define IS_HALF_OGRE(ch)        (GET_RACE(ch) == RACE_HALF_OGRE)
#define IS_BAKALI(ch)           (GET_RACE(ch) == RACE_BAKALI)
#define IS_DEMON(ch)			(GET_RACE(ch) == RACE_DEMON)
#define IS_MOBILE(ch)			(GET_RACE(ch) == RACE_MOBILE)
#define IS_ORC(ch)				(GET_RACE(ch) == RACE_ORC)
#define IS_OGRE(ch)				(GET_RACE(ch) == RACE_OGRE)
#define IS_DRAGON(ch)			(GET_RACE(ch) == RACE_DRAGON)
#define IS_UNDEAD(ch)			(GET_RACE(ch) == RACE_UNDEAD)
#define IS_CAERVUNI(ch)			(GET_RACE(ch) == RACE_CAERVUNI)
