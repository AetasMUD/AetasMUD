...
void assign_mobiles(void)
{
  ...
  // Celestius guildmasters
  ASSIGNMOB(8115, guildmaster);
  ASSIGNMOB(8116, guildmaster);
  ASSIGNMOB(8118, guildmaster);
  ASSIGNMOB(8120, guildmaster);
  ASSIGNMOB(8122, guildmaster);
  ASSIGNMOB(8124, guildmaster);
  ASSIGNMOB(8126, guildmaster);
  ASSIGNMOB(8128, guildmaster);
  ASSIGNMOB(8130, guildmaster);
  ASSIGNMOB(8132, guildmaster);
  ASSIGNMOB(8134, guildmaster);
  ASSIGNMOB(8136, guildmaster);
...
void assign_objects(void)
{
  ...
  ASSIGNOBJ(1206, gen_board);	/* mortal board */
  ASSIGNOBJ(1207, gen_board);	/* imp todo board */
  ASSIGNOBJ(8084, gen_board);	/* celestius barb guild board */
  ASSIGNOBJ(8085, gen_board);	/* celestius theif guild board */
  ASSIGNOBJ(8086, gen_board);	/* celestius psi guild board */
  ASSIGNOBJ(8087, gen_board);	/* celestius monk guild board */
  ASSIGNOBJ(8088, gen_board);	/* celestius druid guild board */
  ASSIGNOBJ(8089, gen_board);	/* celestius ranger guild board */
  ASSIGNOBJ(8090, gen_board);	/* celestius paladin guild board */
  ASSIGNOBJ(8091, gen_board);	/* celestius anti-pal guild board */
  ASSIGNOBJ(8092, gen_board);	/* celestius cleric guild board */
  ASSIGNOBJ(8093, gen_board);	/* celestius evil cleric guild board */
  ASSIGNOBJ(8094, gen_board);	/* celestius mage guild board */
  ASSIGNOBJ(8095, gen_board);	/* celestius necromancer guild board */
